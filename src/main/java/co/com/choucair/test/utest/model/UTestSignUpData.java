package co.com.choucair.test.utest.model;
...
public class UTestSignUpData {
    ...
    private String strTextToWelcome;

    public UTestSignUpData(String strFirstName, String strLastName, String strEmailAddress, String strMount, String strDay, String strYear, String strCity, String strPostalCode, String strCountry, String strComputer, String strVersion, String strLanguage, String strLanguages, String strMovilDevice, String strModel, String strOperatingSystem, String strPassword, String strConfirmPassword, String strTextToWelcome) {
        ...
        this.strTextToWelcome = strTextToWelcome;
    }
    ...
    public String getStrMovilDevice() {
        return strMovilDevice;
    }

    public void setStrMovilDevice(String strMovilDevice) {
        this.strMovilDevice = strMovilDevice;
    }
    ...
    public String getStrTextToWelcome() {
        return strTextToWelcome;
    }

    public void setStrTextToWelcome(String strTextToWelcome) {
        this.strTextToWelcome = strTextToWelcome;
    }
}
